...
public:
	 ...
	 */
	void setAutoDelete (const bool enable);
	 ...
	 */
	unsigned int getNofObjects() const;
	 ...
	 */
	unsigned int getNofEnabledObjects();
	 ...
	 * @see #renderFrame
	 */
	std::string addObject (Object *newObject, const bool makeActive = true, const bool emitSignal = true);
	 ...
	 * @see #renderFrame
	 */
	bool removeObject (Object *object, const bool emitSignal = true);
	 ...
	 * @see #renderFrame
	 */
	void reset (const bool emitSignal = true, const bool renderFrame = true);
	 ...
	 * @see #renderFrame
	 */
	void setActiveObject (const std::string &objectName, const bool renderFrame = true);
	 ...
	 * @see #renderFrame
	 */
	void setTranslation (const float x, const float y, const float z, const bool emitSignal = true);
	 ...
	 * @see #renderFrame
	 */
	void setCameraPosition (const MyDataTypes::CameraPosition cameraPosition, const bool emitSignal = true);
	 ...
	 */
	MyDataTypes::CameraPosition getCameraPosition () const;
	 ...
	 */
	void getTransformationMatrix (MyDataTypes::TransformationMatrix16f transformationMatrix);
	 ...
	 * @see #renderFrame
	 */
	void setSurfelPropertyDescriptor (const SurfelInterface::PropertyDescriptor newPropertyDescriptor);
	 ...
	 * @see #renderFrame
	 */
	void requestSurfelPropertyDescriptor (const SurfelInterface::PropertyDescriptor requestedPropertyDescriptor);
	 ...
	 */
	SurfelInterface::PropertyDescriptor getSurfelPropertyDescriptor() const;
	 ...
	 * @see SurfelInterface#Property
	 */
	void setSurfelPosition (SurfelInterface *surfel, const Vector3D newPosition, const bool emitSignal = true);
	 ...
	 * @see SurfelInterface#Property
	 */
	void setSurfelNormal (SurfelInterface *surfel, const Vector3D newNormal, const bool emitSignal = true);
	 ...
	 * @see SurfelInterface#Property
	 */
	void setSurfelTangentAxes (SurfelInterface *surfel, const Vector3D newAxisOne, const Vector3D newAxisTwo, const bool emitSignal = true);
	 ...
	 * @see SurfelInterface#Property
	 */
	void setSurfelNormalTangentAxesSystem (SurfelInterface *surfel, const Vector3D newNormal, const Vector3D newAxisOne, const Vector3D newAxisTwo, const bool emitSignal = true);
	 ...
	 * @see SurfelInterface#Property
	 */
	void setSurfelRadius (SurfelInterface *surfel, const float newRadius, const bool emitSignal = true);
	 ...
	 * @see SurfelInterface#Property
	 */
	void combineSurfelColorProperties(SurfelInterface *surfel, SurfelInterface *copySurfel1, SurfelInterface *copySurfel2, float factor, const bool emitSignal = true);
	 ...
	 *        the new <code>COLORREF</code> diffuse color of the <code>surfel</code>
	 * @param emitSignal
	 *        set to <code>false</code> if the signal <code>objectModified</code> and <code>renderFrame</code> should
	 *        be supressed; useful if multiple operations have to be done before the image gets
	 *        re-rendered; use with <b>caution</b>
	 ...
	 * @see #renderFrame
	 */
	void setSurfelDiffuseColor (SurfelInterface *surfel, const COLORREF newDiffuseColor, const bool emitSignal = true);
	 ...
	 *        the new <code>COLORREF</code> specular color of the <code>surfel</code>
	 * @param emitSignal
	 *        set to <code>false</code> if the signal <code>objectModified</code> and <code>renderFrame</code> should
	 *        be supressed; useful if multiple operations have to be done before the image gets
	 *        re-rendered; use with <b>caution</b>
	 ...
	 * @see #renderFrame
	 */
	void setSurfelSpecularColor (SurfelInterface *surfel, const COLORREF newDiffuseColor, const bool emitSignal = true);
	 ...
	 * @see #renderFrame
	 */
	void setSurfelFlagOn (SurfelInterface *surfel, const SurfelInterface::Flag flags, const bool on, const bool emitSignal = true);
	 ...
	 * @see #renderFrame
	 */
	void setSurfelFlags (SurfelInterface *surfel, const SurfelInterface::Flags newFlags, const bool emitSignal = true);
	 ...
	 * @see #renderFrame
	 */
	void setAllSurfelFlagsOn (const SurfelInterface::Flags newFlags, const bool on, const bool emitSignal = true);
	 ...
	 * @see #renderFrame
	 */
	void clearAllAssociatedSurfels(const bool emitSignal = true);
	 ...
	 * @see #renderFrame
	 */
	void setSurfelAmbientCoefficient (SurfelInterface *surfel, const float newAmbientCoefficient, const bool emitSignal = true);
	 ...
	 * @see #renderFrame
	 */
	void setSurfelDiffuseCoefficient (SurfelInterface *surfel, const float newDiffuseCoefficient, const bool emitSignal = true);
	 ...
	 * @see #renderFrame
	 */
	void setSurfelSpecularCoefficient (SurfelInterface *surfel, const float newSpecularCoefficient, const bool emitSignal = true);
	 ...
	 * @see #renderFrame
	 */
	void setSurfelShininess (SurfelInterface *surfel, const float newShininess, const bool emitSignal = true);
	 ...
	 * @see #renderFrame
	 */
	void setSurfelTextureCoordinate (SurfelInterface *surfel, const MyDataTypes::TextureCoordinate newTextureCoordinate, const bool emitSignal = true);
	 ...
	 */
	bool addAssociatedSurfel (SurfelInterface *surfel, SurfelInterface *associatedSurfel, const bool emitSignal = true);
	 ...
	 */	
	void clearAssociatedSurfels (SurfelInterface *surfel, const bool emitSignal = true);
	 ...
	 * @see #renderFrame
	 */
	void removeSurfels (std::vector<SurfelInterface*> *surfels, const bool emitSignal = true);
	 ...
	 * @see #renderFrame
	 */
	void removeSurfels (SurfelInterface::Flag flag, const bool emitSignal = true);
	 ...
	 * @see #renderFrame
	 */
	void removeSurfels (Object *object, std::list<SurfelInterface> *surfels, const bool emitSignal = true);
	 ...
	 * @see #renderFrame
	 */
	void removeSurfels (std::vector<SurfelInterface *> surfels, const int nofSurfels, const bool emitSignal = true);
	 ...
	 * @see #objectModified
	 */
	void emitObjectModifiedSignal (bool samplingPatternAltered = false);
