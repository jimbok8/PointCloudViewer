...
public:
	 ...
	 */
	static const SurfelInterface::PropertyDescriptor BaseSurfel_PropertyDescriptor;
	/**
	 * Properties of an el surfel (for consistency with Pointshop3D Version 1.2)
	 */
	static const SurfelInterface::PropertyDescriptor ElSurfel_PropertyDescriptor;
	/**
	 * Properties of an enhanced el surfel
	 */
	static const SurfelInterface::PropertyDescriptor EnhElSurfel_PropertyDescriptor;
	/**
	 * Properties of a surfel1 surfel (for consistency with Pointshop3D Version 1.2)
	 */
	static const SurfelInterface::PropertyDescriptor Surfel1_PropertyDescriptor;
	 ...
	 * @see Property
	 */
	static std::string getUserReadableProperty (const Property property);
	 ...
	 * @see Property
	 */
	static SurfelInterface::Property getSystemProperty (const std::string &userReadableProperty);
	 ...
	 */
	static void getEditableProperties(std::vector<std::string> &vProps);
	 ...
	 */
	static PropertyDescriptor getEditablePropertyDescriptor();
	 ...
	 */
	static int getNumOfEditableProperties();
	 ...
	 */
	static int getNumOfPropertyBrushComponents(Property property);
	 ...
	 */
	static Flags getSelectionFlags();
	 ...
	 *
	 * @return the <code>COLORREF</code> diffuse color
	 * @see Scene#setSurfelDiffuseColor
	 */
	inline COLORREF getDiffuseColor() const;

	/**
	 * Returns the specular color.
	 *
	 * @return the <code>COLORREF</code> specular color
	 * @see Scene#setSurfelSpecularColor
	 */
	inline COLORREF getSpecularColor() const;
...
public:
	 ...
	 *        the new <code>COLORREF</code> diffuse color
	 */
	inline void setDiffuseColor (const COLORREF newDiffuseColor);

	/**
	 * Sets the specular color.
	 *
	 * @param newSpecularColor
	 *        the new <code>COLORREF</code> specular color
	 */
	inline void setSpecularColor (const COLORREF newSpecularColor);
...
inline COLORREF SurfelInterface::getDiffuseColor() const {
	return (sc->*(sc->_getDiffuseColor))(index);
}

inline COLORREF SurfelInterface::getSpecularColor() const {
...
inline void SurfelInterface::setDiffuseColor (const COLORREF newDiffuseColor) {
	(sc->*(sc->_setDiffuseColor))(index, newDiffuseColor);
}

inline void SurfelInterface::setSpecularColor (const COLORREF newSpecularColor) {
