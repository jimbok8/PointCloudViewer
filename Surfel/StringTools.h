...
namespace StringTools {
	 ...
	 *         appended
	 */
	std::string appendSequenceNumber (const std::string &str, const unsigned int sequenceNumber,
	 ...
	 */
	int getSequenceNumber (const std::string &str, const unsigned int nofDigits, const unsigned int position);
