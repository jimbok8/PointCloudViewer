...
public:
	 ...
	 */
	virtual void setSize (const CSize newBufferSize) = 0;
	 ...
	 * @param newPixelColor
	 *        the new <code>COLORREF</code> color for the pixel at position (<code>x</code>, <code>y</code>)
	 */
	virtual void setColor (const int x, const int y, const COLORREF newPixelColor) = 0;
	 ...
	 * @param y
	 *        the y screen coordinate
	 * @return the <code>COLORREF</code> color of the pixel at position (<code>x</code>, <code>y</code>)
	 */
	virtual COLORREF getColor (const int x, const int y) const = 0;
	 ...
	 * <b>Note:</b> render with the option <code>PERPIXEL_C_Z_N_W</code>.
	 *
	 * @return a pointer to a <code>IplImage</code> containing the rendered image
	 */
	 ...
	 *
	 * @param clearColor
	 *        the <code>COLORREF</code> color which is used as background color
	 */
	virtual void clearImage (const COLORREF clearColor) = 0;
	 ...
	 */
	virtual void getVisibleSurfels (const int x, const int y, const std::vector<SurfelInterface *> **visibleSurfels, unsigned int *nofVisible) const = 0;
	...
	/**
	 * Creates a <code>IplImage<code> that contains the z-values as a 8-bit height field. Has to be
	 * <code>delete</code>d after use. <b>Don't use anymore, deprecated</b>
	 *
	 * <b>Note:</b> render with the option <code>PERPIXEL_C_Z_N_W</code>.
	 *
	 * @return a pointer to the <code>IplImage</code>; has to be <code>delete</code> after use
	 * @deprecated
	 */
	virtual CImage* getZImage() const = 0;
	 ...
	 */
	virtual std::list<SurfelInterface*> *getAllVisibleSurfels() = 0;
