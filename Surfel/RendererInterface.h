...
public:
	 ...
	 * @see #getRendererWidget
	 */
	virtual CImage* getRenderedImage() = 0;
	 ...
	 *        the new <code>CSize</code> of the view port [in pixels]
	 */
	virtual void setViewPortSize (const CSize newViewPortSize) = 0;

	/**
	 * Returns the view port size in pixels.
	 *
	 * @return the <code>CSize</code> of the view port [in pixels]
	 */
	virtual CSize getViewPortSize() const = 0;
	 ...
	 */
	virtual void setBackgroundColor(COLORREF newBackgroundColor) = 0;
	 ...
	 *			end point of line
	 */
	virtual void drawLine (const Vector3D start, const Vector3D end, COLORREF color) {
	}
