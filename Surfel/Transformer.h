...
public:
	 ...
	 */
	Transformer (const CSize viewPortSize, const MyDataTypes::ViewFrustum viewFrustum,
	 ...
	 *
	 * @return the <code>CSize</code> specifying the width and height of the view port in pixels
	 */ 
...
public:// slots:
	 ...
	 *        the <code>CSize</code> specifying the width and height of the view port in pixels
	 */
